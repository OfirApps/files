let el = document.getElementById('classMateLogo');
...
//onclick
el.ondblclick = function() {!el.classList.contains("fly-animation") ? gokyliego() : null}
//el.onclick = function () {return window.location.href = '/'}
function gokyliego() {
    if (window.mobileCheck()) {return window.location.href = '/'} //if mobile, don't do anything.
    ...
    el.style.right = `calc(100vw - 15%)`; //makes it go off the screen
    el.style.top = `1rem`;
